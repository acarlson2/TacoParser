...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The two Taco Bells that are the farthest apart from eachother:");
            Console.WriteLine("---------------------------------------------------------------");
            Console.WriteLine("Location A:");
            Console.WriteLine($"Name: {trackableA.Name}");
            Console.WriteLine($"Coordinates: {trackableA.Location.Latitude}, {trackableA.Location.Longitude}");
            Console.WriteLine("---------------------------------------------------------------");
            Console.WriteLine("Location B:");
            Console.WriteLine($"Name: {trackableB.Name}");
            Console.WriteLine($"Coordinates: {trackableB.Location.Latitude}, {trackableB.Location.Longitude}");
            Console.WriteLine("---------------------------------------------------------------");
            Console.WriteLine($"The distance between these two locations is: {distance}");
